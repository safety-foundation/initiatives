### Проект НПА 02/04/11-20/00110705

#### Предложения и ответы на вопросы, предложенные к обсуждению проекта НПА "О внесении изменений в Федеральный закон «Об отходах производства и потребления» и Федеральный закон «Об охране окружающей среды»"

Прошу всех, кто читает этот текст, срочно пройти по ссылке
https://regulation.gov.ru/projects#npa=110705 ,
авторизоваться и проголосовать против законопроекта (значок "палец вниз") 
Дата окончания публичного обсуждения -
17 декабря 2020 г., через два дня!

Данный файл в той версии, в которой он был мною отправлен, доступен по ссылке без авторизации
https://regulation.gov.ru/Files/GetFile?fileid=7f509885-ec64-439d-856a-f42fd339b48b

### Паспорт проекта

- Наименование: О внесении изменений в Федеральный закон «Об отходах производства и потребления» и Федеральный закон «Об охране окружающей среды»
- ID проекта: 02/04/11-20/00110705
- Дата создания: 20 ноября 2020 г.
- Разработчик: Минприроды России
- Ответственный сотрудник: Стефановская Анастасия Васильевна
- Процедура: Оценка регулирующего воздействия
- Вид: Проект федерального закона
- Виды экономической деятельности: Экология
- Ключевые слова: вторресурсы
- Основание для разработки проекта акта: Необходимость систематизации обязательных требований, устранение неточностей в изложении норм статей 11 и 18 Федерального закона от 24.06.1998 № 89-ФЗ «Об отходах производства и потребления» и других положений закона в части нормирования образования отходов и лимитов на их размещение.
